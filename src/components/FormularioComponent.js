  ...
  return (
    <div>
        ...
        {usuario.bio && usuario.bio.length >=1 &&
            (<div className="info_formulario label-gray">
        {usuario.nombre} {usuario.apellido} es un {usuario.genero} y esta es su vida: <p>{usuario.bio}</p>
        </div>)
        }
        ...
        <form onSubmit={conseguirDatosFormulario}>
            ...
            <textarea placeholder="Biografía" name='bio'
